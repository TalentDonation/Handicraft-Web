                        ...
                        <c:forEach begin="0" end="${url.size() - 1}" step="1" var="i">
                            <div class="main-search">
                                <div class="input-group content-group">
                                    <div class="has-feedback has-feedback-left">
                                        <input type="text" class="form-control rUrl" readonly="readonly"
                                               value="${url.get(i)}"/>
                                        <div class="form-control-feedback">
                                            <i class="icon-search4 text-muted text-size-base"></i>
                                        </div>
                                    ...
                                    <div class="input-group-btn">
                                        <button type="button" class="btn btn-primary dropdown-toggle search"
                                                data-toggle="dropdown">조회<span class="caret"></span></button>
